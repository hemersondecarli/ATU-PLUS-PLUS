...
public class EditCourse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 50, -1, 55));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 20, 39, 40));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 240, 130, 60));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Name:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, -1, 32));
        getContentPane().add(nameCourse, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 130, 490, 30));
        ...
        getContentPane().add(codeCourse, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 170, 490, 30));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        EditDeleteCourse editDeletePage = new EditDeleteCourse();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         try {
            if(nameCourse.getText().isEmpty() || codeCourse.getText().isEmpty()) {
                ...
                String sql = "UPDATE course SET name = ?, code = ? WHERE id = ?";  
                String name = nameCourse.getText();
                String code = codeCourse.getText();
                int choice = JOptionPane.showConfirmDialog(this, "Do you want modify Course?", "Confirmation", JOptionPane.YES_NO_OPTION);
                if (choice == JOptionPane.YES_OPTION) {
                    Object[] parametersSQL = {name, code, idCourse};
    ...
    private void loadCourse() {
        try {
            ...
            Object[] parameters = {idCourse};
            ArrayList<Map<String, Object>> result = ConnectionDB.getQuery(sql, parameters);
            for (Map<String, Object> map : result) {
                nameCourse.setText((String)map.get("name"));
                codeCourse.setText((String)map.get("code"));
            }
        } catch (Exception e) {
